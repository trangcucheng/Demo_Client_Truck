...
const DataTablesPage2 = React.lazy(() => import('@app/pages/DataTablesPage2'));
...
const DataTables2 = withLoading(DataTablesPage2);
    ...
    <BrowserRouter>
      <Routes>
        <Route path={MEDICAL_DASHBOARD_PATH} element={protectedLayout}>
          ...
          <Route path="data-tables2" element={<DataTables2 />} />
